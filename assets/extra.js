...
//             type: 'POST',
//             dataType: 'JSON',
//             // http://localhost/wpdistro/wp-content/plugins/wpdsnippets/assets/style.css?ver=5.4.2
//             url: 'wp-content/plugins/wpdsnippets/includes/snippet_toggle.php',
//             data: 'mode=' + mode,
//             success: function (data) {
//                 var data = eval(data);
//                 message = data.message;
//                 success = data.success;
//                 $("#heading_snippet").html(success);
//                 $("#body_snippet").html(message);
//             }
//         });
//     });
//
