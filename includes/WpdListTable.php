...
class WpdListTable extends WP_List_Table
{
...
//
//        parent::__construct([
//            'singular' => __('WPD_snippet', 'wpd_snippets'), //singular name of the listed records
//            'plural' => __('WPD_snippets', 'wpd_snippets'), //plural name of the listed records
//            'ajax' => true //should this table support ajax?
//        ]);
//    }
}

if (class_exists('WpdListTable')) {
    $wpdSnippets = new WpdListTable();
}
